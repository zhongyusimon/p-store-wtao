...
Page({
  ...
  onShareAppMessage: function() {
    ...
    return {
      title: "云之坊，保护我方云南胃～",
      imageUrl: 'https://firefac-1259431066.picsh.myqcloud.com/13vwjv2z69qbtedxpla3vf2jcps1cp5p.jpg',
  ...
  getIndexData: function() {
    ...
    util.request(api.AdMap,{
      codeList: ['topBanner', 'firstVideo', 'firstPage']
    ...
    util.request(api.TopicDetailFilter, {
      code: "firstTop"
    }, "POST").then(function(res) {
      if (res.errcode === '0') {
        that.setData({
        ...
        if(res.data.topic != null){
          WxParse.wxParse('topTopicDetail', 'html', res.data.topic.content, that);
        }
      }
    });
